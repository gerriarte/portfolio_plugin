...
<div class="wrap portfolio-admin">
    <h1 class="wp-heading-inline"><?php _e('Proyectos del Portafolio', 'portfolio-plugin'); ?></h1>
    <button type="button" class="page-title-action" id="add-new-project">
        <?php _e('Agregar Nuevo', 'portfolio-plugin'); ?>
    </button>
                        ...
                        <div class="project-meta">
                            ...
                            <?php if ($project->featured): ?>
                                <span class="featured-badge">
                                    ...
                                    <?php _e('Destacado', 'portfolio-plugin'); ?>
                                </span>
                            <?php endif; ?>
                        </div>
        ...
        <?php else: ?>
            <div class="no-projects">
                <div class="no-projects-content">
                    ...
                    <h3><?php _e('No hay proyectos aún', 'portfolio-plugin'); ?></h3>
                    <p><?php _e('Comienza agregando tu primer proyecto al portafolio.', 'portfolio-plugin'); ?></p>
                    <button type="button" class="button button-primary" id="add-first-project">
                        <?php _e('Agregar Primer Proyecto', 'portfolio-plugin'); ?>
                    </button>
                </div>
            </div>
        <?php endif; ?>
...
<div id="project-modal" class="portfolio-modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h2 id="modal-title"><?php _e('Agregar Nuevo Proyecto', 'portfolio-plugin'); ?></h2>
        ...
        <form id="project-form" class="modal-body">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="project-title"><?php _e('Título del Proyecto', 'portfolio-plugin'); ?> *</label>
                    <input type="text" id="project-title" name="title" required>
                </div>
                
                <div class="form-group">
                    <label for="project-category"><?php _e('Categoría', 'portfolio-plugin'); ?></label>
                    <select id="project-category" name="category_id">
                        <option value=""><?php _e('Seleccionar categoría', 'portfolio-plugin'); ?></option>
            ...
            <div class="form-group">
                <label for="project-description"><?php _e('Descripción', 'portfolio-plugin'); ?></label>
                <textarea id="project-description" name="description" rows="3"></textarea>
            </div>
            
            <div class="form-group">
                <label for="project-content"><?php _e('Contenido Detallado', 'portfolio-plugin'); ?></label>
                <?php
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="project-image"><?php _e('Imagen Destacada', 'portfolio-plugin'); ?></label>
                    <div class="image-upload">
                        ...
                        <button type="button" class="button upload-image-btn">
                            <?php _e('Seleccionar Imagen', 'portfolio-plugin'); ?>
                        </button>
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="project-date"><?php _e('Fecha del Proyecto', 'portfolio-plugin'); ?></label>
                    <input type="date" id="project-date" name="project_date" value="<?php echo date('Y-m-d'); ?>">
                </div>
            </div>
            
            <div class="form-group">
                <label for="project-url"><?php _e('URL Externa', 'portfolio-plugin'); ?></label>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="project-status"><?php _e('Estado', 'portfolio-plugin'); ?></label>
                    <select id="project-status" name="status">
                        <option value="published"><?php _e('Publicado', 'portfolio-plugin'); ?></option>
                        <option value="draft"><?php _e('Borrador', 'portfolio-plugin'); ?></option>
                        <option value="private"><?php _e('Privado', 'portfolio-plugin'); ?></option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <label>
                        ...
                        <?php _e('Proyecto Destacado', 'portfolio-plugin'); ?>
                    </label>
                </div>
            </div>
        </form>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="button button-primary modal-save">
                <?php _e('Guardar Proyecto', 'portfolio-plugin'); ?>
            </button>
        </div>
    </div>
</div>
